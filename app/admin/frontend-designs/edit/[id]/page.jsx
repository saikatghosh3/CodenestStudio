...
import { Save, X, Plus, AlertCircle, Palette } from "lucide-react";

export default function EditFrontendDesign() {
  ...
  useEffect(() => {
    async function fetchDesign() {
      try {
        ...
        if (res.ok) {
          const allDesigns = await res.json();
          const found = allDesigns.find((d) => d._id === params.id);
          if (found) {
            setForm({
              title: found.title || "",
              slug: found.slug || "",
        ...
        setError("Failed to load frontend design. Check your database connection.");
      } finally {
        setFetching(false);
      }
    }
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch(`/api/frontend-designs/${params.id}`, {
        method: "PUT",
      ...
      if (!res.ok) {
        setError(data.error || "Failed to update frontend design");
        return;
      }

      router.push("/admin/frontend-designs");
    } catch {
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">
              This design may have been deleted or the ID is invalid.
            </p>
            <button
              onClick={() => router.push("/admin/frontend-designs")}
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Update frontend design details
            </p>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium">Featured Design</span>
                </label>
              </div>
            </div>
