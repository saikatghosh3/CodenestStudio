...
import { Save, X, Plus, AlertCircle, Link, Image, Code, Globe, Github, FolderOpen, Star, Palette } from "lucide-react";

export default function CreateFrontendDesign() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Failed to create frontend design");
        return;
      }
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Add a new frontend design to your showcase
              </p>
            </div>
          </div>
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    placeholder="Describe the design, its purpose, and key features..."
